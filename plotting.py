...
def plot_population_results(
    experiments: List[Dict[str, Any]],
    steps: int,
    filename: str = "output/figure_population.png",
    show: bool = True,
) -> None:
    x = np.arange(steps)
...
def plot_final_state_and_lineages(
    experiments: List[Dict[str, Any]],
    filename: str = "output/figure_lineages.png",
    show: bool = True,
) -> None:
    fig, axes = plt.subplots(
        1, len(experiments), figsize=(4.5 * len(experiments), 4), sharex=False, sharey=False
    )
